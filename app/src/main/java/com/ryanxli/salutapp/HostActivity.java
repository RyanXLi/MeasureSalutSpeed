...
import static com.ryanxli.salutapp.ClientActivity.trialSize;
import static com.ryanxli.salutapp.ClientActivity.trials;
...
//        }
        ...
        {
            Message newMessage = LoganSquare.parse((String) data, Message.class);
            messageArrayList.add(trialCount + " ACK");
            Log.d(TAG, "added.");
            arrayAdapter.notifyDataSetChanged();
            listView.smoothScrollToPosition(messageArrayList.size() - 1);
            ...
            if (trialCount < trials) {
                ...
                messageArrayList.add("Test of size " + trialSize / 1024 + " finished.");
                Log.d(TAG, "added.");
                arrayAdapter.notifyDataSetChanged();
                listView.smoothScrollToPosition(messageArrayList.size() - 1);
            }
